...
#### Here's the different column names in the data-set
```{r}
colnames(stud_perf_2018)
```

#### Here's the overall summary statistic for all the columns in stud_perf_2018 data-set:
```{r}
