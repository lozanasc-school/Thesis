...
Trial mapping of already numerical values
Result: Didn't work

STUDENT_PROFILE_2018$MATH <- ifelse(STUDENT_PROFILE_2018$`MATH`=='-', 0,
                               ifelse(STUDENT_PROFILE_2018$`MATH` <= 300, 3,
                               ifelse(STUDENT_PROFILE_2018$`MATH` <= 400, 5,
                               ifelse(STUDENT_PROFILE_2018$`MATH` <= 599, 8,
                               ifelse(STUDENT_PROFILE_2018$`MATH` >= 600, 10,
                               NA)))))

STUDENT_PROFILE_2018$SCIENCE <- ifelse(STUDENT_PROFILE_2018$`SCIENCE`=='-', 0,
                               ifelse(STUDENT_PROFILE_2018$`SCIENCE` <= 400, 3,
                               ifelse(STUDENT_PROFILE_2018$`SCIENCE` <= 500, 5,
                               ifelse(STUDENT_PROFILE_2018$`SCIENCE` <= 799, 8,
                               ifelse(STUDENT_PROFILE_2018$`SCIENCE` >= 800, 10,
                               NA)))))
...
<div class="alert alert-info" role="alert">
  <strong> BSS/TSS Ratio: </strong> 0.0302 (the nearer the ratio to 1 the better)
</div>
